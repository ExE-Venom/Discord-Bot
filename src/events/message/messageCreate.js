      ...
      .embed(
        {
          ...
          fields: [
            {
              name: "📨┆Invite me",
              value: `Invite me on your own server! [Click here](${client.config.discord.botInvite})`,
            },
            {
              name: "❓┇I don't see any slash commands",
              value:
                "The bot may not have permissions for this. Open the invite link again and select your server. Then bot gets the correct permissions",
            },
            {
              name: "❓┆Need support?",
