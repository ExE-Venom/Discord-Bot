...
module.exports = async (client, interaction, args) => {
    ...
    client.soundboard(interaction.guild.id, interaction, "https://www.myinstants.com/media/sounds/movie_1.mp3");

    client.succNormal({ text: "Soundboard started! Playing **bruh**", type: 'editreply' }, interaction);
};