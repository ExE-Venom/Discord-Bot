...
module.exports = async (client, interaction, args) => {
    ...
    client.soundboard(interaction.guild.id, interaction, "https://www.myinstants.com/media/sounds/o-holero-cho-to-freddy-fazbear.mp3");

    client.succNormal({ text: "Soundboard started! Playing **freddy fazbear** meme", type: 'editreply' }, interaction);
};