...
module.exports = async (client, interaction, args) => {
    ...
    client.soundboard(interaction.guild.id, interaction, "https://www.myinstants.com//media/sounds/rick-astley-never-gonna-give-you-up_9j9vMfn.mp3");

    client.succNormal({ text: "Soundboard started! Playing **rickroll**", type: 'editreply' }, interaction);
};