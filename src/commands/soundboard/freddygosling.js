...
module.exports = async (client, interaction, args) => {
    ...
    client.soundboard(interaction.guild.id, interaction, "https://www.myinstants.com/media/sounds/freddy-fazber-x-rayan-gosling.mp3");

    client.succNormal({ text: "Soundboard started! Playing **Freddy Fazbear X Rayan Gosling** meme", type: 'editreply' }, interaction);
};