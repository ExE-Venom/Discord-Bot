...
module.exports = async (client, interaction, args) => {
    ...
    client.soundboard(interaction.guild.id, interaction, "https://www.myinstants.com/media/sounds/battotai-drip-remix.mp3");

    client.succNormal({ text: "Soundboard started! Playing **kamikaze** song", type: 'editreply' }, interaction);
};