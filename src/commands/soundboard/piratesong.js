...
module.exports = async (client, interaction, args) => {
    ...
    client.soundboard(interaction.guild.id, interaction, "https://www.myinstants.com//media/sounds/five-nights-at-freddys-foxys-piratesong.mp3");

    client.succNormal({ text: "Soundboard started! Playing **foxy's piratesong**", type: 'editreply' }, interaction);
};