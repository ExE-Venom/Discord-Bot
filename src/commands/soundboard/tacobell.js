...
module.exports = async (client, interaction, args) => {
    ...
    client.soundboard(interaction.guild.id, interaction, "https://www.myinstants.com/media/sounds/taco-bell.mp3");

    client.succNormal({ text: "Soundboard started! Playing **tacobell**", type: 'editreply' }, interaction);
};