...
module.exports = async (client, interaction, args) => {
    ...
    return Promise.all(promises)
        .then(async results => {
            ...
            const duration = (Date.now() / 1000 - client.uptime / 1000).toFixed(0);
            
            client.embed({
                title: `:information_source:・${client.user.username} information`,
                desc: `—————————————————`,
                thumbnail: client.user.avatarURL({ size: 1024 }),
                fields: [
               {
                    name: ":information_source:┆Information",
                    value: `${client.user.username} is a bot with which you can run your entire server! With no less than 350+ commands, we have a large bot with many options to improve your server!`,
                    inline: false,
                },
                {
                    name: "————————————————— \n\n│General",
